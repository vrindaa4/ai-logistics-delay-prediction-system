              ...
              <div className='card-body rounded-5 homeimg1 '>
                <div className='homeimg2ds'>
                  <Fade bottom>
                    ...
                    <a href="https://budhshiv.com/products/brass-superfine-lord-ganesha-and-goddess-lakshmi-idol-set-4?variant=45982400119013&country=IN&currency=INR&utm_medium=product_sync&utm_source=google&utm_content=sag_organic&utm_campaign=sag_organic&gad_source=1&gclid=CjwKCAiAxqC6BhBcEiwAlXp451sW0B0jDphCPBCEB2wVw42jHFDB4oYpyula6trJddkekWKXgPR68hoCQLgQAvD_BwE">
              ...
              <div className='card-body rounded-5  homeimg2 '>
                <div className='homeimg2ds'>
                  <Fade bottom>
                    <h4>Copper</h4>
                    <p className='text-white'>Add elegance and charm to <br /> your home with these <br /> beautiful masterpieces</p>
                    <a href="https://giri.in/products/balaji-murti-2-5-x-1-inches-copper-idol">
            ...
            <div className='card border-0' >
              ...
              <div className='card-body cardbg p-3  '>
                <Fade bottom>
                  ...
                  <a href="https://theindianethnicco.com/collections/ajrakh-fabric?srsltid=AfmBOoqiF001dqOBNQOB7ms2MELDxGXnDyHwTQHNxZmoZSIA--kwzoMk">
            ...
            <div className='card border-0'>
              ...
              <div className='card-body cardbg p-3 '>
                <Fade bottom>
                  ...
                  <a href="https://taroob.in/products/heirloom-kalamkari-pichwai-ras-leela-pure-pashmina-shawl?variant=49721591759159&utm_source=google&utm_medium=organic&utm_campaign=Google%20Shopping%20India&utm_content=Heirloom%20Kalamkari%20Pichwai%20Ras-Leela%20Pure%20Pashmina%20Shawl&gad_source=1&gclid=CjwKCAiA6aW6BhBqEiwA6KzDc6NvCWk2hjrQ2zqrYhPXkN66YzAzUf-ws_5i6t3ZjaKxVypeJ2ZgihoCTMgQAvD_BwE"
                  >
                  <button className='btn btn-warning border-white mt-3 rounded-0'>Shop Now</button></a>
                </Fade>
            ...
            <div className='card border-0'>
              ...
              <div className='card-body cardbg  p-3 '>
                <Fade bottom>
                  ...
                  <a href="https://www.instagram.com/sui_dhaga.official/?hl=en">
                  <button className='btn btn-warning border-white mt-3 rounded-0'   > Shop Now</button>
                  </a>
                </Fade>
...
{/* 
        ...
        <div className='row justify-content-evenly justify-content-center'>
          ...
          {/* <div className='col-md-4 p-5 justify-content-evenly justify-content-center'>
            <div className='card border-0'>
              <div className='card-head'>
                <img className='img-fluid' src="https://www.amazon.in/Bombay-Store-Diary-Leather-Shatranj/dp/B08KZP4R46" alt="" />
              </div>
              <div className='card-body cardbg p-3 '>
                <Fade bottom>
          ...
          <div className='col-md-4 p-5 justify-content-evenly justify-content-center'>
            <div className='card border-0' >
              ...
              <div className='card-body cardbg p-3  '>
                <Fade bottom>
                  <h4>Below Rs500</h4>
                  <a href="https://www.amazon.in/s?k=handmade+gifts&s=price-asc-rank&crid=2ORVQXF2ZO2JC&qid=1732870130&sprefix=handmade+gifts%2Caps%2C224&ref=sr_st_price-asc-rank&ds=v1%3AKK6s07g%2BXPtpuHQ399ggio8hk23tG23JW1t%2BtGqkJ5E">
          ...
          <div className='col-md-4 p-5 justify-content-evenly justify-content-center'>
            <div className='card border-0' >
              ...
              <div className='card-body cardbg p-3  '>
                <Fade bottom>
                  <h4>For Him</h4>
                  <a href="https://www.amazon.in/handmade-gifts-for-men/s?k=handmade+gifts+for+men">
          ...
          <div className='col-md-4 p-5 justify-content-evenly justify-content-center'>
            <div className='card border-0'>
              ...
              <div className='card-body cardbg p-3 '>
                <Fade bottom>
                  <h4>For Her</h4>
                  <a href="https://www.karmadori.com/products/hazley-ravishing-rubies-patola-silk-patchwork-kantha-long-jacket?variant=42884422402093&country=IN&currency=INR&utm_medium=product_sync&utm_source=google&utm_content=sag_organic&utm_campaign=sag_organic&tm=tt&ap=gads&aaid=adaQbnqHaBZLh&gad_source=1&gclid=CjwKCAiA6aW6BhBqEiwA6KzDczx7x_-1yi9-Bb0Yi9Maa2U-fUBVxDD_8UKUg7iooNwmrzbJ9WaTCxoCTiMQAvD_BwE">
          ...
          <div className='col-md-4  p-5 justify-content-evenly justify-content-center'>
            <div className='card border-0 '>
              ...
              <div className='card-body cardbg   p-3 '>
                <Fade bottom>
                  <h4 >House Warming</h4>
                  <a href="https://kottanz.com/house-warming/?srsltid=AfmBOopxvM7R4kVaVofQo6_8oIj4PoXPQeD7i0GDoKsiEREbHi7hKtF0">
                  <button className='btn btn-warning border border-dark mt-3 rounded-0 text-white fw-bold px-3 py-2' style={{ backgroundColor: 'orange' }}>Shop Now</button>
                  </a>
                </Fade>
              </div>
