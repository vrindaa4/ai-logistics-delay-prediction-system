...
const UpdateUser = () => {
    ...
    const fetchUserData = async () => {
        const res = await fetch("http://localhost:1002/user/getid/" + id);
    ...
    const uploadFile = async (e) => {
        ...
        const res = await fetch('http://localhost:1002/util/uploadfile', {
            method: 'POST',
            body: fd
        });
        console.log(res.status);
                            ...
                            userData !== null ? (
                                <Formik initialValues={userData}
                                    onSubmit={async (values) => {
                                        ...
                                        const res = await fetch('http://localhost:1002/user/update/' + id, {
                                            method: 'PUT',
